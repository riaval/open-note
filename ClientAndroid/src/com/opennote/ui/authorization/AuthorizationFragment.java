package com.opennote.ui.authorization;
...
public class AuthorizationFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.activity_opening, container, false);
...
//	}
	...
	public void signInAction(View view){
		EditText loginInEdit   = (EditText) getView().findViewById(R.id.loginInEdit);
		EditText passInEdit   = (EditText) getView().findViewById(R.id.passInEdit);
	...
	public void signUpAction(View view){
		EditText loginInEdit   = (EditText) getView().findViewById(R.id.loginUpEdit);
		EditText fullNameUpEdit   = (EditText) getView().findViewById(R.id.fullNameUpEdit);
		EditText passInEdit   = (EditText) getView().findViewById(R.id.passUpEdit);
