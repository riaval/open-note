...
import com.opennote.model.provider.GroupContact.Group;
...
public class GroupProvider extends ContentProvider {
	...
	static {
		...
		sUriMatcher.addURI(GroupContact.AUTHORITY, GroupContact.Group.CONTENT_PATH, PATH_GROUPS); 
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		case PATH_GROUPS: {
			...
			cursor.setNotificationUri(getContext().getContentResolver(), GroupContact.Group.CONTENT_URI);
			return cursor;
		}
		default:
			return null;
	...
	public String getType(Uri uri) {
		switch (sUriMatcher.match(uri)) {
		case PATH_GROUPS:
			return GroupContact.Group.CONTENT_TYPE;
		default:
			return null;
		}
	}
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		case PATH_GROUPS: {
			...
			getContext().getContentResolver().notifyChange(GroupContact.Group.CONTENT_URI, null);
		}
		default:
			return null;
		}
